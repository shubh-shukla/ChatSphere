...
const Profile = () => {
  ...
  return (
    <div className="flex h-full min-h-screen bg-background">
      <Nav />
      <div className="w-[91%] flex items-center bg-[#0a1340]">
            ...
            <div className="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
              <div className="w-full">
                ...
                <input
                  ...
                  name="firstName"
                  id="firstName"
                  className=" border b  text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 bg-[#324ba6] border-gray-600 placeholder-gray text-white focus:ring-primary-500 focus:border-primary-500"
              ...
              <div className="sm:col-span-2">
                ...
                <input
                  ...
                  id="email"
                  disabled
                  className="border text-sm rounded-lg focus:ring-primary-600 block w-full p-2.5 bg-[#324ba6] border-gray-600 placeholder-gray text-gray-400  ring-primary-500 "
